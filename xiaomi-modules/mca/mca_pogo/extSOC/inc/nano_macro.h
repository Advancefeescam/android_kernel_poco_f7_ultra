...
#include <mca/battmngr/platform_class.h>
...
#define I2C_ADDR_POGO_PIN            (0x0E)
#define I2C_ADDR_C3                  (0x2E)
#define I2C_ADDR_TYPEC               (0x4E)

#define TYPEC_POWER_15W              (0xE)
#define TYPEC_POWER_12W              (0xA)
#define TYPEC_POWER_10W              (0x6)
#define TYPEC_POWER_7P5W             (0x2)

#define POGO_IBUS_2P                 (2000)
#define POGO_IBUS_1P75               (1750)
#define POGO_IBUS_1P5                (1500)     
#define POGO_IBUS_1P25               (1250)
#define POGO_IBUS_1P                 (1000)
#define POGO_IBUS_0P75               (750)
#define POGO_IBUS_0P375              (375)

#define POGO_VOLTAGE_THRESHOLD       (12000)
#define MAX_45W_TIME_10M             (600)
...
struct nanochg {
    ...
    struct delayed_work	power_distribution_work;
};

struct temp_power_map {
    u8 index;
    u16 temp_l;
    u16 temp_h;
    u16 typec_power;
    u16  pogo_ibus;
    u16  single_pogo_ibus;
};
...
extern int  Nanosic_ADSP_Set_Charge_Status_Single(uint8_t addr, uint8_t addrlen, uint8_t* data, uint32_t datalen, uint8_t target);
...
extern int Nanosic_ADSP_Read_Charge_Status_Single(uint8_t addr, uint8_t addrlen, uint8_t target);
extern int  Nanosic_ADSP_Read_803_Version(void);
