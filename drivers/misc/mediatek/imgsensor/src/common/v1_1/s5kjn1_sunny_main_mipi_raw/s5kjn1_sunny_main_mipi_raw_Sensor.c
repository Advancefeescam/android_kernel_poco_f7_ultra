...
#include "s5kjn1_sunny_main_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1_SUNNY_MAIN_SENSOR_ID ,
...
#define XTALK_DATA_ADDR	0x1E1D
#define HW_GGC_SIZE	346
#define HW_GGC_ADDR	0x3D65
#define QSC_FLAG_ADDR	0x1E1C
#define QSC_FLAG_VALID	0x01
#define CHECKSUM_ADDR	0x3EBF
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_s5kjn1sunny[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void custom2_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom2_s5kjn1sunny,
		sizeof(addr_data_pair_custom2_s5kjn1sunny) / sizeof(kal_uint16));
}
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				{
#endif
					pr_info("s5kjn1sunny_sunny i2c 0x%x, sid 0x%x\n",
...
UINT32 S5KJN1_SUNNY_MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("S5KJN1_SUNNY_MAIN_MIPI_RAW_SensorInit in\n");
