...
static int fts_ito_test_show(struct seq_file *file, void *data)
{
	...
	if ((fts_ftest->test_item[FTS_RAWDATA_TEST].testresult) && (fts_ftest->test_item[FTS_SCAP_CB_TEST].testresult) && (fts_ftest->test_item[FTS_SCAP_RAWDATA_TEST].testresult))
	...
	//noise test result
	if (fts_ftest->test_item[FTS_NOISE_TEST].testresult)
