...
struct strategy_fg_cfg {
	...
	int support_global;
	int sdp_decrease_iterm[FG_IC_MAX];
};
...
struct strategy_fg {
	...
	struct delayed_work master_force_report_full_work;
	struct delayed_work slave_force_report_full_work;
	...
	bool fg_init_flag;
	bool fg_batt_master_auth;
	bool fg_batt_slave_auth;
	int chg_status;
	...
	int sa_status_last;
	int sa_status;
	bool fg_master_init_flag;
	bool fg_slave_init_flag;
	bool fg_master_error;
	bool fg_slave_error;
	};
