...
//ipc debug cfg
#define IPC_TRACE_FW2AP_OPEN
#define IPC_TRACE_AP2FW_OPEN

#define IPC_RPMSG_MAX_TIMEOUT_US (10000)
#define IPC_MBOX_MAX_TIMEOUT_US	 (8000)
#define IPC_KICK_MAX_TIMEOUT_US	 (8000)
