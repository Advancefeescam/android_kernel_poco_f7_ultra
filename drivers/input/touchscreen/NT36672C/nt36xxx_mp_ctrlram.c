...
/*L19A code for HQ-213698 by gaoxue at 2022/5/30 start*/
...
/*L19A code for HQ-213698 by gaoxue at 2022/5/30 end*/
...
/*L19A code for HQ-235102 by lizongrui at 2022/12/12 start*/
	seq_printf(m,
		   ...
		   ts->lockdowninfo[0], ts->lockdowninfo[1],
		   ts->lockdowninfo[2], ts->lockdowninfo[3],
		   ts->lockdowninfo[4], ts->lockdowninfo[5],
		   ts->lockdowninfo[6], ts->lockdowninfo[7]);
...
/*L19A code for HQ-194769 by gaoxue at 2022/4/17 start*/
static const struct proc_ops nvt_tp_selftest_fops = {
	//.owner = THIS_MODULE,
	.proc_open = nvt_tp_selftest_open,
	.proc_lseek = seq_lseek,
	.proc_release = seq_release,
	.proc_write = nvt_tp_selftest_store,
	.proc_read = seq_read,
};
/*L19A code for HQ-194769 by gaoxue at 2022/4/17 end*/
