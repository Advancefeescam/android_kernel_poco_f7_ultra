...
wl2866_ldo_pin_map_t wl2866_ldo_pin_map[] = {
	...
	{ IMGSENSOR_SENSOR_IDX_MAIN, IMGSENSOR_HW_PIN_AVDD1, WL2866_LDO_AVDD2},
	{ IMGSENSOR_SENSOR_IDX_MAIN, IMGSENSOR_HW_PIN_DVDD1, WL2866_LDO_DVDD2},
	{ IMGSENSOR_SENSOR_IDX_SUB, IMGSENSOR_HW_PIN_DVDD1, WL2866_LDO_DVDD2}, //1.2V
	{ IMGSENSOR_SENSOR_IDX_SUB, IMGSENSOR_HW_PIN_AVDD1, WL2866_LDO_AVDD2}, //2.8V
	{ IMGSENSOR_SENSOR_IDX_MAIN2, IMGSENSOR_HW_PIN_AVDD1, WL2866_LDO_AVDD2}, //2.8V, Depth
	{ IMGSENSOR_SENSOR_IDX_MAIN2, IMGSENSOR_HW_PIN_DVDD1, WL2866_LDO_DVDD2},
	{ IMGSENSOR_SENSOR_IDX_SUB2, IMGSENSOR_HW_PIN_AVDD1, WL2866_LDO_AVDD2}, //2.8V, Macro
	{ IMGSENSOR_SENSOR_IDX_SUB2, IMGSENSOR_HW_PIN_DVDD1, WL2866_LDO_DVDD2},
			 ...
			 const struct i2c_device_id *id)
{
	...
	/*L19A code for HQ-199297 by xuyanfei at 2022/7/14 start */
	/*
	...
	*/
	/*L19A code for HQ-199297 by xuyanfei at 2022/7/14 end */
