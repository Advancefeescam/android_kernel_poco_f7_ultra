...
static const struct proc_ops tp_differ_proc_fops = {
	//.owner = THIS_MODULE,
	.proc_read = tp_differ_proc_read,
};
static const struct proc_ops tp_rawdata_proc_fops = {
	//.owner = THIS_MODULE,
	.proc_read = tp_rawdata_proc_read,
};
