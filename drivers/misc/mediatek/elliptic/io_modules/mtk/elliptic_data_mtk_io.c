	...
	size_t data_size)
{
    ...
    /* P6 Ultral patch start */
	{
		int *data_ptr = (int *)host_message.data;
		pr_info("[ELUS-%s] id=%d,size=%d,type=%d,data=%d", __func__,
			host_message.header.elliptic_ipi_message_id, host_message.header.data_size, *(data_ptr), *(data_ptr+1));
	}
	/* P6 Ultral patch end */
