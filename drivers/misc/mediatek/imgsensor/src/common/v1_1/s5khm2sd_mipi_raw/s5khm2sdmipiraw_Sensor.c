...
#include "s5khm2sdmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KHM2SD_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[11] = {
	...
	{ 12000, 9000,    0,     0,  12000, 9000, 12000, 9000,    0,    0, 12000, 9000,    0,    0, 12000, 9000}, // custom1 full size capture
...
static void sensor_init(void)
{
    ...
    mdelay(1);
	table_write_cmos_sensor(s5khm2sd_sunny_init_setting_1,
			sizeof(s5khm2sd_sunny_init_setting_1) / sizeof(kal_uint16));
    mdelay(5);
    ...
    // Global
	table_write_cmos_sensor(s5khm2sd_sunny_init_setting_2,
			sizeof(s5khm2sd_sunny_init_setting_2) / sizeof(kal_uint16));
}	/*	sensor_init  */
...
UINT32 S5KHM2SD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
