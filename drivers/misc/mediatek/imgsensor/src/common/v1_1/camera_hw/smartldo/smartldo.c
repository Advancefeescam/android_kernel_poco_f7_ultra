...
wl2866_ldo_votage_map_t wl2866_ldo_dvdd_votage_map[] = {
	...
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_950, 0x3A},// 0.950V
...
wl2866_ldo_votage_map_t sgm38121_ldo_avdd_votage_map[] = {
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_2200, 0x66},// 2.2V
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_2800, 0xB1},// 2.8V
};
wl2866_ldo_votage_map_t sgm38121_ldo_dvdd_votage_map[] = {
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_950, 0x38},//  0.950V
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_1100, 0x4B},// 1.1V
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_1200, 0x57},// 1.2V
};
uint32_t chipid =0;
