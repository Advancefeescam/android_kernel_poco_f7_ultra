...
int pd_dpm_send_source_caps(struct pd_port *pd_port)
{
	...
	DPM_INFO("cable_limit: %dmA, limit_curr: %dmA\n", cable_curr, limit_curr);

	cable_curr = (cable_curr < limit_curr) ? cable_curr : limit_curr;
