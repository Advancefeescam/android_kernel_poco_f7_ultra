...
#include <dt-bindings/xring/common/smc_id/bl31_smc_id.h>
...
static int gpu_subsys_power_init(struct device *dev, struct xring_regulator_ip *sreg)
{
	...
	gpu_subsys_regs.gpc_regs.gpc_req.phy_addr =
		sreg->phy_addr.base_gpu_lpctrl + LPCTRL_GPU_GPU_TOP_GPC_PU_REQ_POLL;
	gpu_subsys_regs.gpc_regs.gpc_intr.phy_addr =
		sreg->phy_addr.base_gpu_lpctrl + LPCTRL_GPU_INTR_PU_GPU_TOP;
	gpu_subsys_regs.autofsctrl27.phy_addr =
		sreg->phy_addr.base_peri_crg + PERI_CRG_AUTOFSCTRL27;
	gpu_subsys_regs.adb_q_channel_cfg.phy_addr =
		sreg->phy_addr.base_gpu_ctrl + GPU_XCTRL_ADB_Q_CHANNEL_CFG;
	gpu_subsys_regs.q_channel_state_2.phy_addr =
		sreg->phy_addr.base_gpu_ctrl + GPU_XCTRL_Q_CHANNEL_STATE_2;
	gpu_subsys_regs.gpu_snd_sys_ctrl.phy_addr =
		sreg->phy_addr.base_gpu_ctrl + GPU_XCTRL_GPU_SND_SYS_CTRL;
...
static int dpu_part1_power_init(struct device *dev, struct xring_regulator_ip *sreg)
{
	...
	dpu_part1_regs.gpc_regs.gpc_req.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_GPC_PU_REQ_POLL_DPU_PART1;
	dpu_part1_regs.gpc_regs.gpc_intr.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_INTR_PU_DPU_PART1;
	dpu_part1_regs.mem_lpctrl_req_group0.phy_addr =
		sreg->phy_addr.base_media1_lpctrl_ft + MEDIA1_LPCTRL_FT_MEM_LPCTRL_REQ_GROUP0;
	dpu_part1_regs.dpu_glb_grp_ds.phy_addr =
		sreg->phy_addr.base_dpu_glb + DPU_GLB_GRP_DS;
...
static int dpu_part2_power_init(struct device *dev, struct xring_regulator_ip *sreg)
{
	...
	dpu_part2_regs.gpc_req.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_GPC_PU_REQ_POLL_DPU_PART2;
	dpu_part2_regs.gpc_intr.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_INTR_PU_DPU_PART2;
...
static int veu_top_power_init(struct device *dev, struct xring_regulator_ip *sreg)
{
	...
	veu_top_regs.gpc_req.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_GPC_PU_REQ_POLL_VEU;
	veu_top_regs.gpc_intr.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_INTR_PU_VEU;
...
static int vdec_core_power_init(struct device *dev, struct xring_regulator_ip *sreg)
{
	...
	vdec_core_regs.gpc_regs.gpc_req.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_GPC_PU_REQ_POLL_VDEC;
	vdec_core_regs.gpc_regs.gpc_intr.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_INTR_PU_VDEC;
	vdec_core_regs.m1_dpu_dvfs_bypass.phy_addr =
		sreg->phy_addr.base_media1_crg + MEDIA1_CRG_M1_DPU_DVFS_BYPASS;
...
static void gpu_subsys_sec_dump(struct device *dev)
{
	...
	base = sreg->phy_addr.base_gpu_lpctrl + 0x800;
...
static void gpu_subsys_debug(struct device *dev, struct xring_regulator_ip *sreg)
{
	...
	phy_addr = sreg->phy_addr.base_gpu_lpctrl;
	size = 0x200;
	...
	phy_addr = sreg->phy_addr.base_acpu_gpu_crg + GPU_SUBCHIP_CRG_CLKGT0_W1S;
	size = 0x50;
	_reg_dump(dev, phy_addr, size);
