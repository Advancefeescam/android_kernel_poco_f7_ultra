...
/**
 * cmdlist_dbg_enable - enable or disable cmdlist dbg irq
 * @enable: mask or unmask the cmdlist dbg irq
 */
void cmdlist_dbg_enable(bool enable);

/**
 * cmdlist_dbg_clear - clear cmdlist dbg irq raw status
 */
void cmdlist_dbg_clear(void);

/**
 * cmdlist_dbg_save - return cmdlist dbg irq raw status
 */
