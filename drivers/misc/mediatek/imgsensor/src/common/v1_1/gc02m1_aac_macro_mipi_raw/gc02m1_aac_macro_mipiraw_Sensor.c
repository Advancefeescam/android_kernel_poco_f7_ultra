...
#include "gc02m1_aac_macro_mipiraw_Sensor.h"
#define L19A_VENDOR_ID_ENABLE 1
#define PFX "GC02M1_aac_macro_camera_sensor"
#define LOG_1 LOG_INF("GC02M1_AAC_MACRO,MIPI 1LANE\n")
...
static kal_uint32 return_sensor_id(void)
{
	...
	pr_err("changqi sensor_id read is %x!", tmp_id);
	if (tmp_id == 0x2e0) {
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			pr_err("changqi get_imgsensor_id read is %x!",
				   *sensor_id);
