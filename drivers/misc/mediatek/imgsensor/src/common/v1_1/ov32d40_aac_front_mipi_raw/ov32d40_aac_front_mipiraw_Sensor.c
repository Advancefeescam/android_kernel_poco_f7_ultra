...
#include "ov32d40_aac_front_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV32D40_AAC_FRONT_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 return_sensor_id(void)
{
	...
	printk("[%s] OV32D40_AAC_FRONT sensor_id: 0x%x vendor_id: 0x%x sensorinfo_id: 0x%x", __func__, sensor_id, imgsensor.vendor_id, imgsensor_info.sensor_id);
	if ((VENDOR_ID == imgsensor.vendor_id) && (sensor_id == imgsensor_info.sensor_id))
	{
		sensor_id = OV32D40_AAC_FRONT_SENSOR_ID;
		printk("[%s] OV32D40_AAC_FRONT sensor_id: 0x%x", __func__, sensor_id);
	}
	else
		sensor_id = 0;
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(ov32d40aac_init_setting,
			sizeof(ov32d40aac_init_setting) / sizeof(kal_uint16));
}	/*	sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(ov32d40aac_preview_setting,
		sizeof(ov32d40aac_preview_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void capture_setting(void)
{
	...
	table_write_cmos_sensor(ov32d40aac_capture_setting,
		sizeof(ov32d40aac_capture_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */

static void normal_video_setting(void)
{
	printk("loading normal_video_setting\n");
	table_write_cmos_sensor(ov32d40aac_normal_video_setting,
		sizeof(ov32d40aac_normal_video_setting) / sizeof(kal_uint16));
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(ov32d40aac_hs_video_setting,
		sizeof(ov32d40aac_hs_video_setting) / sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov32d40aac_custom1_setting,
		sizeof(ov32d40aac_custom1_setting) / sizeof(kal_uint16));
}

static void custom2_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov32d40aac_custom2_setting,
		sizeof(ov32d40aac_custom2_setting) / sizeof(kal_uint16));
}
static void custom3_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov32d40aac_custom3_setting,
		sizeof(ov32d40aac_custom3_setting) / sizeof(kal_uint16));
}
...
static void custom4_setting(void)
{
	...
	table_write_cmos_sensor(ov32d40aac_custom4_setting,
		sizeof(ov32d40aac_custom4_setting) / sizeof(kal_uint16));
}
/*************************************************************************
* FUNCTION
*	get_imgsensor_id
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	LOG_INF("OV32D40AAC get_imgsensor_id in\n");
		...
		UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1831200;
		break;
...
{
    LOG_INF("OV32D40_AAC_FRONT_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV32D40_AAC_FRONT_MIPI_RAW_SensorInit	*/
