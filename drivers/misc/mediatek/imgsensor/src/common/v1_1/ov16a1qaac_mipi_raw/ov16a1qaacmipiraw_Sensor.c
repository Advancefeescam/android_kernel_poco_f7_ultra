...
#include "ov16a1qaacmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16A1QAAC_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 return_sensor_id(void)
{
	...
	if ((VENDOR_ID == imgsensor.vendor_id) && ((sensor_id+1)== imgsensor_info.sensor_id))
{
            sensor_id = OV16A1QAAC_SENSOR_ID;	
...
UINT32 OV16A1QAAC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("OV16A1QAAC_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV16A1QAAC_MIPI_RAW_SensorInit	*/
