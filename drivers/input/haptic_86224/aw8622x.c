...
#include "aw8622x.h"
#include "haptic.h"
/* P6 code for HQFEAT-118569 by p-zhoutingting17 at 2025/07/01 start */
#include "../xm-haptic.h"
/* P6 code for HQFEAT-118569 by p-zhoutingting17 at 2025/07/01 end */
	...
	if (aw8622x_haptic_cont_get_f0(aw8622x)) {
		...
		if ((aw8622x->f0 < f0_cali_min) || aw8622x->f0 > f0_cali_max) {
			aw_dev_err(aw8622x->dev,
				   ...
				   __func__, aw8622x->f0);
			/* P6 code for HQFEAT-118569 by p-zhoutingting17 at 2025/07/01 start */
			XM_HAP_F0_CAL_EXCEPTION(aw8622x->f0, aw8622x->dts_info.f0_ref, "F0 Calibration failed, use default val");
			/* P6 code for HQFEAT-118569 by p-zhoutingting17 at 2025/07/01 end */
...
static void aw8622x_haptic_misc_para_init(struct aw8622x *aw8622x)
{
	...
	/* P6 code for HQFEAT-171163 by p-zhoutingting17 at 2025/07/31 start */
	aw8622x_i2c_write_bits(aw8622x, AW8622X_REG_ANACFG4,
			       AW8622X_BIT_ANACFG4_UVLO_ADK_MASK,
			       AW8622X_BIT_ANACFG4_UVLO_ADK_2P6);
	/* P6 code for HQFEAT-171163 by p-zhoutingting17 at 2025/07/31 end */
