...
int Nanosic_regulator_init(struct nano_i2c_client *I2client, struct device_node *of_node, struct i2c_client *client)
{
    ...
    if (!ret)
    {
        dbgprint(INFO_LEVEL, "get vdd-name %s", I2client->vdd_name);
    ...
    else
    {
        ...
        if (!ret)
        {
            dbgprint(INFO_LEVEL, "get dvdd-name %s", I2client->dvdd_name);
    ...
    dbgprint(INFO_LEVEL, "set vdd 3300000-3300000");
    ...
    dbgprint(INFO_LEVEL, "set dvdd 1800000-1800000");
    ...
    dbgprint(INFO_LEVEL, "regulator init success!");
...
int Nanosic_switch_regulator(struct nano_i2c_client *I2client, bool on)
{
    ...
    if (on)
    {
        ...
        dbgprint(INFO_LEVEL, "enable vdd start!\n");
        ...
        dbgprint(INFO_LEVEL, "regulator enable success!\n");
    }
    else
    {
        ...
        dbgprint(INFO_LEVEL, "regulator disable success!\n");
    }
