...
/*L19A code for HQ-213698 by gaoxue at 2022/5/31 start*/
...
/*L19A code for HQ-213698 by gaoxue at 2022/5/31 end*/
...
EXPORT_SYMBOL(fts_tp_data_dump_proc_init);
...
EXPORT_SYMBOL(fts_tp_data_dump_proc_exit);
#endif
#if	FTS_TP_SELFTEST
...
static const struct proc_ops fts_tp_selftest_ops = {
...
EXPORT_SYMBOL(fts_tp_selftest_proc_init);
...
EXPORT_SYMBOL(fts_tp_selftest_proc_exit);
#endif
