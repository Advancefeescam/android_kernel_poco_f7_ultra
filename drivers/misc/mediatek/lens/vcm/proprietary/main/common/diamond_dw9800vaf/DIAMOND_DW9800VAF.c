...
#define AF_DRVNAME "DIAMOND_DW9800VAF_DRV"
...
static int s4DIAMOND_DW9800VAF_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long DIAMOND_DW9800VAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DIAMOND_DW9800VAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DIAMOND_DW9800VAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
	...
	if (*g_pAF_Opened == 1) {
		initdrv();
		ret = s4DIAMOND_DW9800VAF_ReadReg(&InitPos);
...
int DIAMOND_DW9800VAF_GetFileName(unsigned char *pFileName)
{
