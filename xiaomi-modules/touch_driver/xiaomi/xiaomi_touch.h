...
typedef struct hardware_operation {
	...
	void (*cmd_update_func)(long mode_update_flag, int mode_value[Touch_Mode_NUM]);
...
#endif
void driver_update_touch_mode(s8 touch_id, int touch_mode[Touch_Mode_NUM], long update_mode_mask);
