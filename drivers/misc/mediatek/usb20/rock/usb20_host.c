...
static void do_host_work(struct work_struct *data)
{
	...
	/*L19A L19A-50 modify otg deep sleep not recognized by miaozhichao at 2022/06/15 start*/
	__pm_stay_awake(mtk_musb->usb_lock);
	/*L19A L19A-50 modify otg deep sleep not recognized by miaozhichao at 2022/06/15 end*/
	/*
