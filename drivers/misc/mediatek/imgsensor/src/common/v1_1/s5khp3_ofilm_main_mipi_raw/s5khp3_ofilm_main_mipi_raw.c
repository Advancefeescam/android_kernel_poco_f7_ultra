...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.custom2 = {/*4080*2296 @30fpsIDCG 12 bit raw*/
		.pclk = 2000000000,
		.linelength  = 11520,
		.framelength = 5776,
		.startx = 0,
	...
	.custom7 = {/*1920*1080 30fps  pipe mode*/
		.pclk = 2000000000,
		.linelength = 6608,
		.framelength = 10080,
		.startx = 0,
	...
	.custom8 = {///*16320*12288 6fps sensor full size*/
		.pclk = 2000000000,
		.linelength  = 26560,
		.framelength = 12496,
		.startx = 0,
...
static kal_uint32 get_sensor_temperature(void)
{
	...
	S5KHP3OFILM_LOG_INF("temp_c(%d) 'C, read_reg(0x%x)\n", temperature_convert, temperature);
...
/*N6 code for HQ-342415 by HQ camera at 20231102 start*/
static void s5khp3ofilm_set_curr_lens_data(u8 *para, u32 *len)
{
...
/*O6 code for HQ-404760 by xiexinli at 20240902 end*/
		S5KHP3OFILM_LOG_INF("%s lp:0x%x\n", __func__, lp);
	} else
		S5KHP3OFILM_LOG_INF("%s sensor is not stream on, lp:0x%x\n", __func__, lp);
}
/*N6 code for HQ-342415 by HQ camera at 20231102 end*/
...
static kal_uint32 streaming_control(struct imgsensor_struct imgsensor,kal_bool enable)
{
	...
	if (enable) {
		if(enable_cont)
		{
			S5KHP3OFILM_LOG_INF("No need to do it againstreaming_enable for enable_cont:%d\n",enable_cont);
		}else
		{
			enable_cont = 1;
...
{
	S5KHP3OFILM_LOG_INF("12bit IDCG E\n");
	table_write_cmos_sensor(s5khp3ofilm_idcg_12bit_setting,
			sizeof(s5khp3ofilm_idcg_12bit_setting) / sizeof(kal_uint16));
}
...
{
	S5KHP3OFILM_LOG_INF("E\n");
	table_write_cmos_sensor(s5khp3ofilm_custom6_setting,
			sizeof(s5khp3ofilm_custom6_setting) / sizeof(kal_uint16));
}
...
{
	S5KHP3OFILM_LOG_INF("E\n");
	table_write_cmos_sensor(s5khp3ofilm_custom9_setting,
			sizeof(s5khp3ofilm_custom9_setting) / sizeof(kal_uint16));
}
...
static void custom10_setting(void)
{
	...
	table_write_cmos_sensor(s5khp3ofilm_custom10_setting,
			sizeof(s5khp3ofilm_custom10_setting) / sizeof(kal_uint16));
}
/*************************************************************************
* FUNCTION
*	get_imgsensor_id
...
static kal_uint32 open(void)
{
	...
	S5KHP3OFILM_LOG_INF("PLATFORM:MT6789, MIPI 3LANE\n");
...
static kal_uint32 custom2(
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	S5KHP3OFILM_LOG_INF("loading custom2_setting IDCG\n");
...
static kal_uint32 custom9(
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	S5KHP3OFILM_LOG_INF("loading custom9_setting\n");
...
static kal_uint32 custom10(
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	S5KHP3OFILM_LOG_INF("loading custom10_setting\n");
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, kal_uint32 shutter, kal_uint32 gain,kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
	...
	{
		//mdelay(30);
		S5KHP3OFILM_LOG_INF("seamless switch to normal_video! gain(%d), shutter(%d)\n", gain, shutter);
		spin_lock(&imgsensor_drv_lock);
		imgsensor.sensor_mode = scenario_id;
		imgsensor.autoflicker_en = KAL_FALSE;
		imgsensor.pclk = imgsensor_info.normal_video.pclk;
	...
	case MSDK_SCENARIO_ID_CUSTOM9:
	{
		S5KHP3OFILM_LOG_INF("MSDK_SCENARIO_ID_CUSTOM9 seamless switch to 2x mode! gain(%d), shutter(%d)\n", gain, shutter);
		spin_lock(&imgsensor_drv_lock);
		imgsensor.sensor_mode = scenario_id;
		imgsensor.autoflicker_en = KAL_FALSE;
		imgsensor.pclk = imgsensor_info.custom9.pclk;
	...
	case MSDK_SCENARIO_ID_CUSTOM10:
	{
		S5KHP3OFILM_LOG_INF("MSDK_SCENARIO_ID_CUSTOM10 seamless switch to 4x mode! gain(%d), shutter(%d)\n", gain, shutter);
		spin_lock(&imgsensor_drv_lock);
		imgsensor.sensor_mode = scenario_id;
		imgsensor.autoflicker_en = KAL_FALSE;
		imgsensor.pclk = imgsensor_info.custom10.pclk;
...
//P6 code for BUGP6-1886 by p-xiezhenghui, 20250726, start
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 942000;//Referring to MTK FAQ21698 ,adjustment only affects sensor_fusion
		break;
//P6 code for BUGP6-1886 by p-xiezhenghui, 20250726, end
	...
	case SENSOR_FEATURE_GET_VC_INFO2:
		...
		case MSDK_SCENARIO_ID_CUSTOM2:
			memcpy((void *)pvcinfo2, (void *)&SENSOR_VC_INFO2[5],
				sizeof(struct SENSOR_VC_INFO2_STRUCT));
				S5KHP3OFILM_LOG_INF("enter custom2 get vc info 5\n");	
			break;
		case MSDK_SCENARIO_ID_CUSTOM3:
	...
	case SENSOR_FEATURE_GET_SEAMLESS_SCENARIOS:
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			...
			*(pScenarios + 1) = MSDK_SCENARIO_ID_CUSTOM10;//14
			S5KHP3OFILM_LOG_INF("MSDK_SCENARIO_ID_VIDEO_PREVIEW to MSDK_SCENARIO_ID_CUSTOM9 + MSDK_SCENARIO_ID_CUSTOM10");
			break;
		...
		//case MSDK_SCENARIO_ID_CUSTOM8: //full size
			*pScenarios = MSDK_SCENARIO_ID_VIDEO_PREVIEW;//2
			S5KHP3OFILM_LOG_INF("MSDK_SCENARIO_ID_CUSTOM9 or MSDK_SCENARIO_ID_CUSTOM10 to MSDK_SCENARIO_ID_VIDEO_PREVIEW\n");
			break;
		default:
			*pScenarios = 0xff;
			break;
...
/*N6 code for HQ-342415 by HQ camera at 20231102 start*/
	case SENSOR_FEATURE_SET_CURR_LENS_DATA:
		s5khp3ofilm_set_curr_lens_data((u8 *)feature_data, feature_para_len);
	break;
/*N6 code for HQ-342415 by HQ camera at 20231102 end*/
