...
#include "SKhynix_A003_128_256.h"
#include "MICRON_128GB_0106.h"
#include "SKhynix_A003_discrete_64_128.h"
#include "UC234_FW_3_4.h"
#include "UC234_FW_3_6.h"
#include "UC234_FW_3_9.h"
...
#define PART_NUMBER 				(17)		//sda14 --> bk07
...
/*M17-T code for HQ-267778 by gaoshilin at 22.12.08 start*/
static struct fw_update_checklist need_update_k[] = {
	...
	{"SKhynix\0", "H9QT0GECN6X145\0", "A001","A003",
	(uint64_t)SKhynix_A003_128_256, sizeof(SKhynix_A003_128_256)},
	{"SKhynix\0", "H9QT0GECN6X145\0", "A002","A003",
	(uint64_t)SKhynix_A003_128_256, sizeof(SKhynix_A003_128_256)},
	{"SKhynix\0", "H9QT0G6CN6X146\0", "A001","A003",
	(uint64_t)SKhynix_A003_128_256, sizeof(SKhynix_A003_128_256)},
	{"SKhynix\0", "H9QT0G6CN6X146\0", "A002","A003",
	(uint64_t)SKhynix_A003_128_256, sizeof(SKhynix_A003_128_256)},
	{"SKhynix\0", "H9QT1G6DN6X132\0", "A002","A003",
	(uint64_t)SKhynix_A003_128_256, sizeof(SKhynix_A003_128_256)},
	{"SKhynix\0", "H9QT1G6DN6X132\0", "A002","A003",
	(uint64_t)SKhynix_A003_128_256, sizeof(SKhynix_A003_128_256)},
	{"SKhynix\0", "HN8G962EHKX037\0", "A001","A003",
	(uint64_t)SKhynix_A003_discrete_64_128, sizeof(SKhynix_A003_discrete_64_128)},
	{"SKhynix\0", "HN8G962EHKX037\0", "A002","A003",
	(uint64_t)SKhynix_A003_discrete_64_128, sizeof(SKhynix_A003_discrete_64_128)},
	{"SKhynix\0", "HN8T062EHKX039\0", "A001","A003",
	(uint64_t)SKhynix_A003_discrete_64_128, sizeof(SKhynix_A003_discrete_64_128)},
	{"SKhynix\0", "HN8T062EHKX039\0", "A002","A003",
	(uint64_t)SKhynix_A003_discrete_64_128, sizeof(SKhynix_A003_discrete_64_128)},
	{"SKhynix\0", "HN8T162EHKX041\0", "A001","A003",
	(uint64_t)SKhynix_A003_discrete_64_128, sizeof(SKhynix_A003_discrete_64_128)},
	{"SKhynix\0", "HN8T162EHKX041\0", "A002","A003",
	(uint64_t)SKhynix_A003_discrete_64_128, sizeof(SKhynix_A003_discrete_64_128)},
	{"MICRON\0", "MT128GAXAU2U228C\0", "0101","0106",
	(uint64_t)MICRON_128GB_0106, sizeof(MICRON_128GB_0106)},
	{"MICRON\0", "MT128GAXAU2U227X\0", "0101","0106",
	(uint64_t)MICRON_128GB_0106, sizeof(MICRON_128GB_0106)},
	{"YMTC\0", "YMUS7B2TE1A2C1\0", "3.2","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_9)},
	{"YMTC\0", "YMUS7B2TE1A2C1\0", "3.4","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_9)},
	{"YMTC\0", "YMUS7B2TE1A2C1\0", "3.6","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_9)},//64
	{"YMTC\0", "YMUS8B2TE2A2C1\0", "3.2","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_6)},
	{"YMTC\0", "YMUS8B2TE2A2C1\0", "3.4","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_6)},
	{"YMTC\0", "YMUS8B2TE2A2C1\0", "3.6","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_9)},//128
	{"YMTC\0", "YMUS9B2TE3A2C1\0", "3.2","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_9)},
	{"YMTC\0", "YMUS9B2TE3A2C1\0", "3.4","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_9)},
	{"YMTC\0", "YMUS9B2TE3A2C1\0", "3.6","3.9",
	(uint64_t)UC234_FW_3_9, sizeof(UC234_FW_3_9)},//256
};
/*M17-T code for HQ-267778 by gaoshilin at 22.12.08 end*/
