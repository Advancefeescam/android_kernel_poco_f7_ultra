...
#define NORMAL_SRC_CAP         0x20019064 //5V1A
#define LOW_SOC_SRC_CAP        0x20019032 //5V0.5A
#define LOW_TEMP_SRC_CAP       0x20019014 //5V0.2A
