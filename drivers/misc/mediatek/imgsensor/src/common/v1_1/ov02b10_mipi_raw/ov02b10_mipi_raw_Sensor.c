...
static  imgsensor_info_struct imgsensor_info = {
	...
	.framelength = 1227,    /*record different mode's framelength*/
...
static void preview_setting(void)
{
    ...
    write_cmos_sensor(0xfd, 0x03);
    write_cmos_sensor(0xc2, 0x01);//p3:c2数据流开关寄存器
 ...
 *
 * DESCRIPTION
 *    This function setup the CMOS sensor in capture MY_`OUTPUT mode
 *
 * PARAMETERS
 *
 * RETURNS
