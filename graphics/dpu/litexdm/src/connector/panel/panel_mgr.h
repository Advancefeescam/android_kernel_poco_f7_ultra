...
#define PANEL_LOCKDOWN_INFO_LEN 8
...
struct panel_lockdown_config {
	struct dsi_cmd_set id_cmd;
	struct dsi_cmd_set lockdown_tx_cmd;
	u8 lockdown_info[PANEL_LOCKDOWN_INFO_LEN];
	u32 lockdown_cmds_rlen;
};

struct panel_wp_info_config {
	struct dsi_cmd_set id_cmd;
	struct dsi_cmd_set wp_info_tx_cmd;
	u32 wp_info_cmds_rlen;
	u8 *return_buf;
};
