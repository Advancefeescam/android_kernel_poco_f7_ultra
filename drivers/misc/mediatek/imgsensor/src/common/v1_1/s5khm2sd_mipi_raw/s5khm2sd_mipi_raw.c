...
static void sensor_init(void)
{
    ...
    mdelay(1);
	table_write_cmos_sensor(s5khm2sd_sunny__init_setting_1,
			sizeof(s5khm2sd_sunny__init_setting_1) / sizeof(kal_uint16));
	mdelay(5);
	...
	// Global
	table_write_cmos_sensor(s5khm2sd_sunny__init_setting_2,
			sizeof(s5khm2sd_sunny__init_setting_2) / sizeof(kal_uint16));
}	/*	sensor_init  */
