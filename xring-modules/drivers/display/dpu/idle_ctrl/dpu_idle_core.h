...
#define DEFAULT_IDLE_EXPIRE_FRAME_NUM 8
...
enum idle_mode {
	IDLE_NONE                   = 0,
	IDLE_SELF_FLUSH_WITH_DSC    = BIT(0), /* self flush depends on dsc，for video */
	...
	IDLE_SELF_FLUSH_WITH_GPU    = BIT(13), /* self flush depends on gpu comp video */
};
 ...
 * @monitor_wq: wait queue for interrupt idle thread
