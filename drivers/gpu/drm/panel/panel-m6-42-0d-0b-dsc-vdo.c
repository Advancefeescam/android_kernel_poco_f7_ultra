...
/*M6 code for HQ-248525 by yuyang at 2022/10/11 start*/
#include <linux/hqsysfs.h>
/*M6 code for HQ-248525 by yuyang at 2022/10/11 end*/
...
static void lcm_panel_init(struct lcm *ctx)
{
    ...
    lcm_dcs_write_seq_static(ctx, 0x35, 0x00);  //00 frame sysnc; 01 line sync
    lcm_dcs_write_seq_static(ctx, 0x6C, 0x02);  //120fps
    lcm_dcs_write_seq_static(ctx, 0x70, 0x11, 0x00, 0x00, 0x89, 0x30, 0x80, 0x09, 0x60, 0x04, 0x38,
	...
	lcm_dcs_write_seq_static(ctx, 0xCF, 0x09, 0x02, 0x9D, 0x9C, 0x7F);
	...
	lcm_dcs_write_seq_static(ctx, 0xD1, 0x00, 0x04, 0x04, 0x06, 0x07, 0x08, 0x08, 0x09, 0x00, 0xFE, 0xFC, 0xFA, 0xFA, 0xF9, 0xF7, 0xF7,
										0x00, 0x04, 0x04, 0x06, 0x07, 0x08, 0x08, 0x09, 0x00, 0xFE, 0xFC, 0xFA, 0xFA, 0xF9, 0xF7, 0xF7,
										0x00, 0x04, 0x04, 0x06, 0x07, 0x08, 0x08, 0x09, 0x00, 0xFE, 0xFC, 0xFA, 0xFA, 0xF9, 0xF7, 0xF7);
	lcm_dcs_write_seq_static(ctx, 0xD2, 0x00, 0x04, 0x04, 0x07, 0x07, 0x09, 0x09, 0x0A, 0x00, 0xFC, 0xFC, 0xFA, 0xFA, 0xF9, 0xF7, 0xF7,
										0x00, 0x04, 0x04, 0x07, 0x07, 0x09, 0x09, 0x0A, 0x00, 0xFC, 0xFC, 0xFA, 0xFA, 0xF9, 0xF7, 0xF7,
										0x00, 0x04, 0x04, 0x07, 0x07, 0x09, 0x09, 0x0A, 0x00, 0xFC, 0xFC, 0xFA, 0xFA, 0xF9, 0xF7, 0xF7);
	lcm_dcs_write_seq_static(ctx, 0xD4, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03,
										0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03,
										0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xD5, 0x00, 0xFE, 0xFE, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03,
										0x00, 0xFE, 0xFE, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03,
										0x00, 0xFE, 0xFE, 0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x01, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03);
	lcm_dcs_write_seq_static(ctx, 0xD6, 0x00, 0x03, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
										0x00, 0x03, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00,
										0x00, 0x03, 0x02, 0x02, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xAA, 0x10);
	lcm_dcs_write_seq_static(ctx, 0xD0, 0x84, 0x35);
	/* Page Disable */
	...
	lcm_dcs_write_seq_static(ctx, 0x00);
	pr_info(" %s end !\n", __func__);
}
					       ...
					       unsigned int mode)
{
	...
	pr_info(" %s lcm:drm_display_mode \n", __func__);
...
static struct attribute *ft3680_attrs[] = {
	&dev_attr_mipi_reg.attr,
	NULL,
};
static const struct attribute_group ft3680_attr_group = {
	.attrs = ft3680_attrs,
};
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	/*M6 code for HQ-242983 by yuyang at 22/09/28 start*/
	ret = sysfs_create_group(&dev->kobj, &ft3680_attr_group);
	if (ret)
		return ret;
	/*M6 code for HQ-242983 by yuyang at 22/09/28 end*/
	pr_info("%s-\n", __func__);
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "m6_42_0d_0b_dsc_vdo,lcm",
	},
	{}
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
			.name = "panel-m6-42-0d-0b-dsc-vdo",
			.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("panel-m6-42-0d-0b-dsc-vdo Panel Driver");
